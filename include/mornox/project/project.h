...
struct SingleFileModel final : public ProjectAttachment {
    static constexpr const char* kAttachmentId = "mornox.singleFile";
...
inline constexpr std::string_view kGroup = "mornox.group";
inline constexpr std::string_view kFile = "mornox.file";
inline constexpr std::string_view kDirectory = "mornox.directory";
inline constexpr std::string_view kModule = "mornox.module";
}
